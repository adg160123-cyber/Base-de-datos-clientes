...
<context>
  ...
  <reference_files>
    ...
    - src/Infrastructure/Models/Data/ClientEntity.cs
...
<task_description>
  ...
  <steps>
    ...
    <step id="2">
      ...
      - Usar SqlCommand y SqlDataReader para el mapeo manual de ClientEntity.
      - Evitar llamadas genéricas de Dapper que dependan de reflexión interna.
    </step>
    
    <step id="3">
      Mapeo: Utilizar 'ClientMapper' para convertir entidades de persistencia a modelos de dominio.
    </step>
